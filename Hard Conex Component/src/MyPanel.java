...
public class MyPanel extends JPanel {
    ...
    public MyPanel()
    {
        ...
        JButton hardConexComponentButton = new JButton("Paint Hard Conex Component");
        hardConexComponentButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                hardConexComponent();
            }
        });
        ...
        bottomPanel.add(hardConexComponentButton);
    ...
    public Vector<Integer> conexComponentGetT2() {
...
//                        System.out.println("EXISTA ARC DE LA: " + getNumber(arc.getStartNode()) + " LA " + getNumber(arc.getEndNode()));
    ...
    public void conexComponentForHardConex(Vector<Integer> t2)
    {
        Color[] culori = {Color.RED, Color.GREEN, Color.BLUE, Color.YELLOW, Color.ORANGE, Color.MAGENTA};
        int indexCuloare = 0;
        ...
        for(int i=1; i<t2.size(); i++) {
            int number = t2.get(S);
            if (t2.get(i) > t2.get(S) && t2.get(i) != -1) {
                S = i;
            }
        }
        t2.set(S, -1);
...
//                        System.out.println("EXISTA ARC DE LA: " + getNumber(arc.getStartNode()) + " LA " + getNumber(arc.getEndNode()));
                        ...
                        V.add(endNode);
                        exist = true;
//                        System.out.println("ELIMINAM: " + (number - 1) + " t2.get(number-1)" + t2.get(number-1));
                        t2.set(number - 1, -1);
                    }
                }
                if (!exist) {
...
//                System.out.println("S: " + S);
    ...
    public void hardConexComponent(){
        Vector<Integer> t2 = conexComponentGetT2();
        for(Arc arc : listaArce){
//            System.out.println("ARC1: " + getNumber(arc.getStartNode()) + " PANA LA " + getNumber(arc.getEndNode()));
            Point aux = arc.getStartPoint().getLocation();
            arc.getStartPoint().setLocation(arc.getEndPoint().getLocation());
            arc.getEndPoint().setLocation(aux);
//            System.out.println("ARC2: " + getNumber(arc.getStartNode()) + " PANA LA " + getNumber(arc.getEndNode()));
        }
//        System.out.println(t2);
        conexComponentForHardConex(t2);
        for(Arc arc : listaArce){
            Point aux = arc.getStartPoint().getLocation();
            arc.getStartPoint().setLocation(arc.getEndPoint().getLocation());
            arc.getEndPoint().setLocation(aux);
